    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button className="bg-black text-white px-5 py-2 rounded-full text-sm font-semibold hover:bg-black/90 transition-colors">
            Let's Talk
          </button>
        </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col items-center gap-8">
              ...
              <button className="mt-4 bg-black text-white px-8 py-3 rounded-full text-lg font-semibold">
                Let's Talk
              </button>
            </div>
          </motion.div>
